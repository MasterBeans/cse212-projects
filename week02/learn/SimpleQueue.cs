public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: IndexOutOfRange
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The result did not output the sequence of the items in the queue in correct order
        ...
        // Defect(s) Found: Executed correctly.
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //The value to dequeue should also be 0 since this is a queue.
        _queue.RemoveAt(0);
        return value;
    }
}